...
# Errant Poisson distribution
set.seed(2501)
fric_exp_pois_df <- fric_exp_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "Poisson", n = 100)

# Errant binomial distribution
set.seed(2501)
fric_exp_binom_df <- fric_exp_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "binomial", n = 100)
```
...
# Errant Poisson distribution
set.seed(2501)
feve_exp_pois_df <- feve_exp_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "Poisson", n = 100)

# Errant binomial distribution
set.seed(2501)
feve_exp_binom_df <- feve_exp_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "binomial", n = 100)
```
