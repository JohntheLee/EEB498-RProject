...
cwm_exp_pois_df_func <- function(trait_df, abun_df, abun_matrix, method, n){
...
cwm_exp_pois_df <- cwm_exp_pois_df_func(trait_df = ksr_trait, abun_df = ksr_abundance, abun_matrix = ksr_abun_matrix, method = "Poisson", n = 100)

# Errant binomial distribution
cwm_exp_binom_df_func <- function(trait_df, abun_df, abun_matrix, method, n){
  true_cwm <- cwm_value_func(trait_df = trait_df, abun_df = abun_df)
  list_errant_cwm <- list()
  repeat_list <- c(1:n)
  for(i in seq_along(repeat_list)){
...
cwm_exp_binom_df <- cwm_exp_binom_df_func(trait_df = ksr_trait, abun_df = ksr_abundance, abun_matrix = ksr_abun_matrix, method = "binomial", n = 100)
```
...
#   cwm_exp_pois_df_func(trait_df = ksr_trait, abun_df = ksr_abundance, abun_matrix = ksr_abun_matrix, method = "Poisson", n = 10),
...
# Errant Poisson distribution
fdis_exp_pois_df_func <- function(trait_df, abun_matrix, method, n){
...
fdis_exp_pois_df <- fdis_exp_pois_df_func(trait_df = ksr_trait_sum, abun_matrix = ksr_abun_sum, method = "Poisson", n = 100)

# Errant binomial distribution
fdis_exp_binom_df_func <- function(trait_df, abun_matrix, method, n){
  true_fdis <- fdis_value_func(trait_df = trait_df, abun_matrix = abun_matrix)
  list_errant_fdis <- list()
  repeat_list <- c(1:n)
  for(i in seq_along(repeat_list)){
...
fdis_exp_binom_df <- fdis_exp_binom_df_func(trait_df = ksr_trait_sum, abun_matrix = ksr_abun_sum, method = "binomial", n = 100)
```
...
# Errant Poisson distribution
fric_exp_pois_df_func <- function(trait_df, abun_df, method, n){
...
fric_exp_pois_df <- fric_exp_pois_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "Poisson", n = 100)

# Errant binomial distribution
fric_exp_binom_df_func <- function(trait_df, abun_df, method, n){
  true_fric <- fric_value_func(trait_df = trait_df, abun_matrix = abun_df)
  list_errant_fric <- list()
  repeat_list <- c(1:n)
  for(i in seq_along(repeat_list)){
...
fric_exp_binom_df <- fric_exp_binom_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "binomial", n = 100)
```
...
# Errant Poisson distribution
feve_exp_pois_df_func <- function(trait_df, abun_df, method, n){
...
feve_exp_pois_df <- feve_exp_pois_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "Poisson", n = 100)

# Errant binomial distribution
feve_exp_binom_df_func <- function(trait_df, abun_df, method, n){
  true_feve <- feve_value_func(trait_df = trait_df, abun_matrix = abun_df)
  list_errant_feve <- list()
  repeat_list <- c(1:n)
  for(i in seq_along(repeat_list)){
...
feve_exp_binom_df <- feve_exp_binom_df_func(trait_df = ksr_REND_trait, abun_df = ksr_REND_abundance, method = "binomial", n = 100)
```
...
# Errant Poisson distribution
shannon_exp_pois_df_func <- function(abun_df, method, n){
...
shannon_exp_pois_df <- shannon_exp_pois_df_func(abun_df = ksr_abundance, method = "Poisson", n = 100)

# Errant binomial distribution
shannon_exp_binom_df_func <- function(abun_df, method, n){
  true_shannon <- shannon_value_func(abun_df = abun_df)
  list_errant_shannon <- list()
  repeat_list <- c(1:n)
  for(i in seq_along(repeat_list)){
...
shannon_exp_binom_df <- shannon_exp_binom_df_func(abun_df = ksr_abundance, method = "binomial", n = 100)
```
